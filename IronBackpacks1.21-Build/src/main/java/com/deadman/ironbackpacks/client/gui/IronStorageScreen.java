...
public class IronStorageScreen extends AbstractContainerScreen<IronStorageMenu> {
    private final static HashMap<String, Object> guistate = IronStorageMenu.guistate;
    private final Level world;
    private final int x, y, z;
    private final Player entity;

    public IronStorageScreen(IronStorageMenu container, Inventory inventory, Component text) {
    ...
    protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
        guiGraphics.drawString(this.font, Component.literal("Iron Backpack"), 6, 6, -12829636, false);
    }

package com.deadman.ironbackpacks;
...
import com.deadman.ironbackpacks.init.Tabs;
import com.deadman.ironbackpacks.init.Screens;
...
public class IronBackpacks
{
    ...
    public IronBackpacks(IEventBus modEventBus, ModContainer modContainer)
    {
